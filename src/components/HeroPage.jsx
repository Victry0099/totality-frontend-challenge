...
const HeroPage = memo(() => {
  return (
    <main className="px-1  md:px-4  pb-4 lg:px-8 lg:pb-8 rounded-2xl">
      <section className="bg-[url('images/rental-hero.jpg')] bg-fixed relative w-full h-[50vh] md:h-[100vh] sm:h-[70vh] bg-center bg-no-repeat md:bg-cover z-0 rounded-5xl">
